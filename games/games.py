...
@app_games.route('/how-to-play/terminal/')
def terminalHTP():
    return render_template("terminalHTP.html")


@app_games.route('/how-to-play/blackscreen/')
def blackscreenHTP():
    return render_template("blackscreenHTP.html")


@app_games.route('/how-to-play/fightorflight/')
def fightorflightHTP():
    return render_template("fightorflightHTP.html")


@app_games.route('/how-to-play/tictactoe/')
def tictactoeHTP():
    return render_template("tictactoeHTP.html")


@app_games.route('/fightorflight/')
def fightorflight():
    return render_template("fightorflight.html")


@app_games.route('/activity/')
def activity():
    return render_template("activity.html")


@app_games.route('/blackscreen/')
def blackscreen():
    return render_template("blackscreen.html")


@app_games.route('/flappybird/')
def flappybird():
    return render_template("flappybird.html")


@app_games.route('/snake/')
def snake():
    return render_template("snake.html")


@app_games.route('/tictactoe/')
def tictactoe():
...
@app_games.route('/terminal/', methods=['GET', 'POST'])
def terminal():
    ...
    if request.form:
        ...
        if currentTerminalPY == 1:
            ...
            if commandInputPY == "echo":
                return render_template("templates/games/terminal.html",
